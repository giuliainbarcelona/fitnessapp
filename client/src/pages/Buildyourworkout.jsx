    ...
    <>
      <div className="buildyour-page">
        <div className="buildyour-content">
          ...
          <br />
          <div className="container-bwo">
            <p className="card card-buildyourworkout">
              You need to choose which muscle group you want to train, <br />{" "}
              for which difficulty level and which type of your workout you
              enojy the most.
            </p>
          </div>
          <br />
          <div className="container-bwo">
            <div className="card card-makeselection">
